...
def send_test_message():
    ...
    try:
        ...
        if not telegram_user and all_users:
            ...
            message = f"🔔 Test Message (Admin: {username}) : Your Telegram integration is working correctly!"
        elif telegram_user:
            message = "🔔 Test Message : Your Telegram integration is working correctly!"
        else:
            return jsonify(
                {
                    "status": "error",
